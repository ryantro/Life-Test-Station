...
https://github.com/ssproessig/Python-PS2000B/blob/6986f04bcd1ca96539b02b8a0b9dfb36599cb6f6/pyps2000b/PS2000B.py
"""
...
def main():
    ...
    # print("Nominal current: {} A".format(device.get_nominal_current()))
    # print("Nominal voltage: {} V".format(device.get_nominal_voltage()))
